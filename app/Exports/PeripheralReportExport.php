...
class PeripheralReportExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    use Exportable;
    ...
    public function __construct($art, $name, $monthone, $monthtwo, $year)
    {
        $this->Report = collect($art);
        $this->name= $name;
    ...
    public function registerEvents(): array{
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1','KARDEX PERIFERICO ');
